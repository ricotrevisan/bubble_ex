...
Names stay unique after each format's case conversion. Ecto, Convex, Xano and
Zod convert names (`created_date`, `createdDate`, `CreatedDateSchema`), which
can merge names that differ only by case or punctuation (`Created Date` and a
